        ...
        <div className="fixed inset-0 z-40 pointer-events-none">
          ...
          >
            ...
            <div className="px-4 py-2 border-b border-gray-800/60 bg-[#0f131a]">
              <p className="text-xs text-gray-400 font-mono">context: {contextLabel}</p>
            </div>

            <div ref={feedRef} className="flex-1 overflow-auto p-4 space-y-3 bg-[#0b0d12]">
            ...
            <div className="border-t border-gray-800/60 bg-[#0f131a] px-4 py-3 space-y-3">
              <div className="rounded-lg border border-gray-800/70 bg-[#0e1219] p-2.5 space-y-2">
                <div className="flex items-center justify-between gap-2">
                  <label htmlFor="global-copilot-provider" className="text-[11px] uppercase tracking-wide text-gray-400">
                    AI Provider
                  </label>
                  <select
