...
\subsection{Functional Evolution Roadmap}
...
\begin{itemize}
    ...
    \item \textbf{Stage 4 - Controlled Multi-Cloud Extension}: reintroduce Azure and GCP modules only after AWS baseline hardening targets are consistently met, including a unified FaaS intent layer mapped to AWS Lambda, Azure Functions, and Google Cloud Functions \cite{aws_lambda_docs_2026, azure_functions_docs_2026, gcp_cloud_functions_docs_2026}.
\end{itemize}
