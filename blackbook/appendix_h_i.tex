...
\begin{figure}[H]
\centering
\begin{tikzpicture}[node distance=4.0cm, auto, scale=0.7, every node/.style={scale=0.7}]
...
\begin{figure}[H]
\centering
\begin{tikzpicture}[node distance=3.4cm, auto, scale=0.48, every node/.style={scale=0.48}]
