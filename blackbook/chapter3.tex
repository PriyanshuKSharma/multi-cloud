...
According to the IEEE-830 standard \cite{ieee830}, we organized our requirements based on functional and non-functional goals.
...
\begin{itemize}
    \item \textbf{Use Case 1: Secure Credential Registration}
        \begin{enumerate}
            ...
            \item The system validates the format using Pydantic schemas \cite{pydantic_docs}.
